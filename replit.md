...
**BotAluguel Pro** — SaaS de bots WhatsApp para usuarios brasileiros. Plataforma completa com criacao de bots, conexao via QR Code ou codigo de 8 digitos (Baileys), builder visual de comandos drag-and-drop, planos em moedas, e pagamento via PIX (EFI Bank real).
...
- **Onboarding/Tutorial removidos**: sem tela de onboarding, sem TourContext/TourOverlay, sem botão "Iniciar Tutorial" nos settings
