...
const TEMPLATES: FlowTemplate[] = [
  ...
  {
    id: "bot_ultra", name: "TUDO INCLUSO", description: "Absolutamente TUDO: sticker + 4 menus + moderação completa + proteção total + 12 jogos + dono + grupo + boas-vindas + despedida + enquete", icon: Bot,
    color: "from-violet-500/20 to-purple-500/20 border-violet-500/30",
    nodes: [
      { id: "tu_c1", type: "command", label: "sticker", config: { trigger: "sticker" }, position: { x: 40, y: 40 } },
      { id: "tu_d1", type: "condition", label: "Tem mídia?", config: { condition: "has_media" }, position: { x: 300, y: 40 } },
      { id: "tu_a1", type: "action", label: "Figurinha", config: { action: "make_sticker", message: "🖼️ Figurinha criada, {nome}!" }, position: { x: 560, y: 0 } },
      { id: "tu_r0", type: "response", label: "Sem mídia", config: { text: "📷 {nome}, envie ou responda a uma imagem/vídeo!" }, position: { x: 560, y: 100 } },
      { id: "tu_c2", type: "command", label: "menu", config: { trigger: "menu" }, position: { x: 40, y: 200 } },
      { id: "tu_a2", type: "action", label: "Menu", config: { action: "show_menu_photo", menu_title: "🤖 Menu do Bot", image_url: "", menu_text: "👤 *{nome}*\n🪙 Moedas: *{moedas}*\n📦 Plano: *{plano}*\n👥 Membros: *{membros}*\n\n═══════════════\n📋 *COMANDOS GERAIS:*\n═══════════════\n🖼️ *{prefix}sticker* — Figurinha\n📢 *{prefix}todos* — Marcar todos\n📋 *{prefix}info* — Info do grupo\n🔗 *{prefix}link* — Link do grupo\n👥 *{prefix}membros* — Lista membros\n📊 *{prefix}enquete* — Criar enquete\n📮 *{prefix}cep* — Consultar CEP\n🧮 *{prefix}calc* — Calculadora\n\n🛡️ *{prefix}menuadmin* — Menu admin\n🎮 *{prefix}menujogos* — Menu jogos\n👑 *{prefix}menudono* — Menu dono", menu_footer: "BotAluguel Pro • {data} {hora}" }, position: { x: 300, y: 200 } },
      { id: "tu_c3", type: "command", label: "menuadmin", config: { trigger: "menuadmin", admin_only: true, group_only: true }, position: { x: 40, y: 360 } },
      { id: "tu_a3", type: "action", label: "Menu Admin", config: { action: "show_menu_admin", menu_title: "🛡️ Menu Admin", menu_text: "👑 *Comandos de Admin:*\n\n🚪 *{prefix}kick* — Remover\n🔨 *{prefix}ban* — Banir\n⬆️ *{prefix}promover* — Promover\n⬇️ *{prefix}rebaixar* — Rebaixar\n⚠️ *{prefix}warn* — Avisar\n🔄 *{prefix}resetwarn* — Resetar avisos\n🗑️ *{prefix}apagar* — Apagar msg\n🔇 *{prefix}mutar* — Mutar\n🔊 *{prefix}desmutar* — Desmutar\n🔒 *{prefix}fechar* — Fechar grupo\n🔓 *{prefix}abrir* — Abrir grupo\n📝 *{prefix}nome* — Mudar nome\n📄 *{prefix}desc* — Mudar descrição\n🔗 *{prefix}revogarlink* — Revogar link", menu_footer: "Apenas admins" }, position: { x: 300, y: 360 } },
      { id: "tu_c4", type: "command", label: "menujogos", config: { trigger: "menujogos", group_only: true }, position: { x: 40, y: 520 } },
      { id: "tu_a4", type: "action", label: "Menu Jogos", config: { action: "show_menu_games", menu_title: "🎮 Menu Jogos", menu_text: "🎮 *Brincadeiras:*\n\n🪙 *{prefix}moeda* — Cara ou coroa\n🎲 *{prefix}dado* — Rolar dado\n🎯 *{prefix}sorteio* — Sortear membro\n💕 *{prefix}amor* — Medidor de amor\n💑 *{prefix}ship* — Shippar\n⭐ *{prefix}nota* — Nota 0 a 10\n🥠 *{prefix}sorte* — Biscoito da sorte\n🎭 *{prefix}vd* — Verdade ou desafio\n🔫 *{prefix}roleta* — Roleta russa\n🏆 *{prefix}top5* — Top 5\n📊 *{prefix}rank* — Ranking\n😂 *{prefix}piada* — Piada", menu_footer: "Diversão garantida!" }, position: { x: 300, y: 520 } },
      { id: "tu_c5", type: "command", label: "menudono", config: { trigger: "menudono", owner_only: true }, position: { x: 40, y: 680 } },
      { id: "tu_a5", type: "action", label: "Menu Dono", config: { action: "show_menu_owner", menu_title: "👑 Menu do Dono", menu_text: "👑 *Exclusivo do Dono:*\n\n✅ *{prefix}ligar* — Ligar bot\n❌ *{prefix}desligar* — Desligar bot\n💰 *{prefix}darmoedas* — Dar moedas\n📢 *{prefix}broadcast* — Msg todos grupos\n🚷 *{prefix}bloquear* — Bloquear user\n✅ *{prefix}desbloquear* — Desbloquear\n👋 *{prefix}boasvindas* — Boas-vindas\n👋 *{prefix}despedida* — Despedida", menu_footer: "Somente o dono" }, position: { x: 300, y: 680 } },
      { id: "tu_c10", type: "command", label: "kick", config: { trigger: "kick", admin_only: true, group_only: true }, position: { x: 860, y: 40 } },
      { id: "tu_a10", type: "action", label: "Kick", config: { action: "kick_member", message: "👋 Removido por {nome}!" }, position: { x: 1120, y: 40 } },
      { id: "tu_c11", type: "command", label: "ban", config: { trigger: "ban", admin_only: true, group_only: true }, position: { x: 860, y: 160 } },
      { id: "tu_a11", type: "action", label: "Ban", config: { action: "ban_member", message: "🔨 Banido por {nome}!" }, position: { x: 1120, y: 160 } },
      { id: "tu_c12", type: "command", label: "promover", config: { trigger: "promover", admin_only: true, group_only: true }, position: { x: 860, y: 280 } },
      { id: "tu_a12", type: "action", label: "Promover", config: { action: "promote_member", message: "⬆️ Promovido a admin!" }, position: { x: 1120, y: 280 } },
      { id: "tu_c13", type: "command", label: "rebaixar", config: { trigger: "rebaixar", admin_only: true, group_only: true }, position: { x: 860, y: 400 } },
      { id: "tu_a13", type: "action", label: "Rebaixar", config: { action: "demote_member", message: "⬇️ Rebaixado!" }, position: { x: 1120, y: 400 } },
      { id: "tu_c14", type: "command", label: "warn", config: { trigger: "warn", admin_only: true, group_only: true }, position: { x: 860, y: 520 } },
      { id: "tu_a14", type: "action", label: "Warn", config: { action: "warn_member", max_warns: "3", message: "⚠️ Aviso! ({args})" }, position: { x: 1120, y: 520 } },
      { id: "tu_c15", type: "command", label: "resetwarn", config: { trigger: "resetwarn", admin_only: true, group_only: true }, position: { x: 860, y: 640 } },
      { id: "tu_a15", type: "action", label: "Reset Warns", config: { action: "reset_warns", message: "🔄 Avisos resetados!" }, position: { x: 1120, y: 640 } },
      { id: "tu_c16", type: "command", label: "mutar", config: { trigger: "mutar", admin_only: true, group_only: true }, position: { x: 860, y: 760 } },
      { id: "tu_a16", type: "action", label: "Mutar", config: { action: "mute_member", message: "🔇 Mutado!" }, position: { x: 1120, y: 760 } },
      { id: "tu_c17", type: "command", label: "desmutar", config: { trigger: "desmutar", admin_only: true, group_only: true }, position: { x: 860, y: 880 } },
      { id: "tu_a17", type: "action", label: "Desmutar", config: { action: "unmute_member", message: "🔊 Desmutado!" }, position: { x: 1120, y: 880 } },
      { id: "tu_c18", type: "command", label: "apagar", config: { trigger: "apagar", admin_only: true, group_only: true }, position: { x: 860, y: 1000 } },
      { id: "tu_a18", type: "action", label: "Apagar", config: { action: "delete_message" }, position: { x: 1120, y: 1000 } },
      { id: "tu_c20", type: "command", label: "todos", config: { trigger: "todos", admin_only: true, group_only: true }, position: { x: 1380, y: 40 } },
      { id: "tu_a20", type: "action", label: "Hidetag", config: { action: "hidetag", message: "📢 {args}" }, position: { x: 1640, y: 40 } },
      { id: "tu_c21", type: "command", label: "info", config: { trigger: "info", group_only: true }, position: { x: 1380, y: 160 } },
      { id: "tu_a21", type: "action", label: "Info", config: { action: "group_info" }, position: { x: 1640, y: 160 } },
      { id: "tu_c22", type: "command", label: "link", config: { trigger: "link", group_only: true }, position: { x: 1380, y: 280 } },
      { id: "tu_a22", type: "action", label: "Link", config: { action: "get_group_link" }, position: { x: 1640, y: 280 } },
      { id: "tu_c23", type: "command", label: "membros", config: { trigger: "membros", group_only: true }, position: { x: 1380, y: 400 } },
      { id: "tu_a23", type: "action", label: "Membros", config: { action: "member_list" }, position: { x: 1640, y: 400 } },
      { id: "tu_c24", type: "command", label: "fechar", config: { trigger: "fechar", admin_only: true, group_only: true }, position: { x: 1380, y: 520 } },
      { id: "tu_a24", type: "action", label: "Fechar", config: { action: "close_group", message: "🔒 Fechado por {nome}!" }, position: { x: 1640, y: 520 } },
      { id: "tu_c25", type: "command", label: "abrir", config: { trigger: "abrir", admin_only: true, group_only: true }, position: { x: 1380, y: 640 } },
      { id: "tu_a25", type: "action", label: "Abrir", config: { action: "open_group", message: "🔓 Grupo aberto!" }, position: { x: 1640, y: 640 } },
      { id: "tu_c26", type: "command", label: "nome", config: { trigger: "nome", admin_only: true, group_only: true }, position: { x: 1380, y: 760 } },
      { id: "tu_a26", type: "action", label: "Nome", config: { action: "set_group_name" }, position: { x: 1640, y: 760 } },
      { id: "tu_c27", type: "command", label: "desc", config: { trigger: "desc", admin_only: true, group_only: true }, position: { x: 1380, y: 880 } },
      { id: "tu_a27", type: "action", label: "Desc", config: { action: "set_group_desc" }, position: { x: 1640, y: 880 } },
      { id: "tu_c28", type: "command", label: "revogarlink", config: { trigger: "revogarlink", admin_only: true, group_only: true }, position: { x: 1380, y: 1000 } },
      { id: "tu_a28", type: "action", label: "Revogar", config: { action: "revoke_group_link", message: "🔄 Link revogado!" }, position: { x: 1640, y: 1000 } },
      { id: "tu_c30", type: "command", label: "moeda", config: { trigger: "moeda", group_only: true }, position: { x: 40, y: 880 } },
      { id: "tu_a30", type: "action", label: "Moeda", config: { action: "coin_flip", message: "🪙 {nome} jogou..." }, position: { x: 300, y: 880 } },
      { id: "tu_c31", type: "command", label: "dado", config: { trigger: "dado", group_only: true }, position: { x: 40, y: 1000 } },
      { id: "tu_a31", type: "action", label: "Dado", config: { action: "dice_roll", dice_sides: "6" }, position: { x: 300, y: 1000 } },
      { id: "tu_c32", type: "command", label: "sorteio", config: { trigger: "sorteio", group_only: true }, position: { x: 40, y: 1120 } },
      { id: "tu_a32", type: "action", label: "Sorteio", config: { action: "pick_random" }, position: { x: 300, y: 1120 } },
      { id: "tu_c33", type: "command", label: "amor", config: { trigger: "amor", group_only: true }, position: { x: 40, y: 1240 } },
      { id: "tu_a33", type: "action", label: "Amor", config: { action: "love_meter" }, position: { x: 300, y: 1240 } },
      { id: "tu_c34", type: "command", label: "ship", config: { trigger: "ship", group_only: true }, position: { x: 40, y: 1360 } },
      { id: "tu_a34", type: "action", label: "Ship", config: { action: "ship_members" }, position: { x: 300, y: 1360 } },
      { id: "tu_c35", type: "command", label: "nota", config: { trigger: "nota", group_only: true }, position: { x: 560, y: 880 } },
      { id: "tu_a35", type: "action", label: "Nota", config: { action: "rate" }, position: { x: 820, y: 880 } },
      { id: "tu_c36", type: "command", label: "sorte", config: { trigger: "sorte", group_only: true }, position: { x: 560, y: 1000 } },
      { id: "tu_a36", type: "action", label: "Sorte", config: { action: "fortune" }, position: { x: 820, y: 1000 } },
      { id: "tu_c37", type: "command", label: "vd", config: { trigger: "vd", group_only: true }, position: { x: 560, y: 1120 } },
      { id: "tu_a37", type: "action", label: "V ou D", config: { action: "truth_or_dare" }, position: { x: 820, y: 1120 } },
      { id: "tu_c38", type: "command", label: "roleta", config: { trigger: "roleta", group_only: true }, position: { x: 560, y: 1240 } },
      { id: "tu_a38", type: "action", label: "Roleta", config: { action: "roulette", roulette_kick: false }, position: { x: 820, y: 1240 } },
      { id: "tu_c39", type: "command", label: "top5", config: { trigger: "top5", group_only: true }, position: { x: 560, y: 1360 } },
      { id: "tu_a39", type: "action", label: "Top 5", config: { action: "top5" }, position: { x: 820, y: 1360 } },
      { id: "tu_c40", type: "command", label: "rank", config: { trigger: "rank", group_only: true }, position: { x: 40, y: 1480 } },
      { id: "tu_a40", type: "action", label: "Ranking", config: { action: "rank" }, position: { x: 300, y: 1480 } },
      { id: "tu_c41", type: "command", label: "piada", config: { trigger: "piada", group_only: true }, position: { x: 560, y: 1480 } },
      { id: "tu_a41", type: "action", label: "Piada", config: { action: "joke" }, position: { x: 820, y: 1480 } },
      { id: "tu_c50", type: "command", label: "ligar", config: { trigger: "ligar", owner_only: true }, position: { x: 1380, y: 1160 } },
      { id: "tu_a50", type: "action", label: "Ligar", config: { action: "bot_on", message: "✅ Bot ligado!" }, position: { x: 1640, y: 1160 } },
      { id: "tu_c51", type: "command", label: "desligar", config: { trigger: "desligar", owner_only: true }, position: { x: 1380, y: 1280 } },
      { id: "tu_a51", type: "action", label: "Desligar", config: { action: "bot_off", message: "❌ Bot desligado!" }, position: { x: 1640, y: 1280 } },
      { id: "tu_c52", type: "command", label: "darmoedas", config: { trigger: "darmoedas", owner_only: true }, position: { x: 1380, y: 1400 } },
      { id: "tu_a52", type: "action", label: "Moedas", config: { action: "give_coins", message: "💰 Moedas enviadas!" }, position: { x: 1640, y: 1400 } },
      { id: "tu_c53", type: "command", label: "broadcast", config: { trigger: "broadcast", owner_only: true }, position: { x: 1380, y: 1520 } },
      { id: "tu_a53", type: "action", label: "Broadcast", config: { action: "broadcast", broadcast_text: "📢 {args}" }, position: { x: 1640, y: 1520 } },
      { id: "tu_c54", type: "command", label: "bloquear", config: { trigger: "bloquear", owner_only: true }, position: { x: 860, y: 1160 } },
      { id: "tu_a54", type: "action", label: "Bloquear", config: { action: "block_user", message: "🚷 Bloqueado!" }, position: { x: 1120, y: 1160 } },
      { id: "tu_c55", type: "command", label: "desbloquear", config: { trigger: "desbloquear", owner_only: true }, position: { x: 860, y: 1280 } },
      { id: "tu_a55", type: "action", label: "Desbloquear", config: { action: "unblock_user", message: "✅ Desbloqueado!" }, position: { x: 1120, y: 1280 } },
      { id: "tu_c56", type: "command", label: "boasvindas", config: { trigger: "boasvindas", owner_only: true, group_only: true }, position: { x: 860, y: 1400 } },
      { id: "tu_a56", type: "action", label: "Boas-Vindas", config: { action: "set_welcome", welcome_text: "👋 Bem-vindo(a) *{nome}* ao *{grupo}*!\n\n📋 Use *{prefix}menu* para ver os comandos.\n👥 Somos *{membros}* membros!" }, position: { x: 1120, y: 1400 } },
      { id: "tu_c57", type: "command", label: "despedida", config: { trigger: "despedida", owner_only: true, group_only: true }, position: { x: 860, y: 1520 } },
      { id: "tu_a57", type: "action", label: "Despedida", config: { action: "set_goodbye", goodbye_text: "👋 *{nome}* saiu do grupo. Até mais!\n👥 Restam *{membros}* membros." }, position: { x: 1120, y: 1520 } },
      { id: "tu_c60", type: "command", label: "enquete", config: { trigger: "enquete", group_only: true }, position: { x: 40, y: 1600 } },
      { id: "tu_a60", type: "action", label: "Enquete", config: { action: "send_poll", poll_question: "O que preferem?", poll_options: "Opção A, Opção B, Opção C" }, position: { x: 300, y: 1600 } },
      { id: "tu_c61", type: "command", label: "cep", config: { trigger: "cep" }, position: { x: 560, y: 1600 } },
      { id: "tu_a61", type: "action", label: "CEP", config: { action: "cep_lookup" }, position: { x: 820, y: 1600 } },
      { id: "tu_c62", type: "command", label: "calc", config: { trigger: "calc" }, position: { x: 40, y: 1720 } },
      { id: "tu_a62", type: "action", label: "Calc", config: { action: "calc" }, position: { x: 300, y: 1720 } },
      { id: "tu_p1", type: "action", label: "Anti-Link", config: { action: "antilink", message: "🚫 {nome}, links proibidos!", kick_on_link: false, warn_on_link: true }, position: { x: 560, y: 1720 } },
      { id: "tu_p2", type: "action", label: "Anti-Spam", config: { action: "antispam", message: "🛡️ {nome}, pare de spam!", warn_on_spam: true }, position: { x: 820, y: 1720 } },
      { id: "tu_p3", type: "action", label: "Anti-Flood", config: { action: "antiflood", message: "💧 {nome}, muitas msgs!", flood_max: "5", flood_interval: "10", kick_on_flood: false }, position: { x: 1080, y: 1720 } },
      { id: "tu_p4", type: "action", label: "Anti-Fake", config: { action: "antifake", message: "🎭 DDI estrangeiro!", allowed_ddis: "55", kick_on_fake: true }, position: { x: 1340, y: 1720 } },
      { id: "tu_p5", type: "action", label: "Anti-Palavrão", config: { action: "antitoxic", message: "🤬 {nome}, linguagem!", kick_on_toxic: false }, position: { x: 1600, y: 1720 } },
      { id: "tu_p6", type: "action", label: "Anti-Delete", config: { action: "antidelete", message: "👁️ {nome} apagou:\n{quoted}" }, position: { x: 40, y: 1840 } },
      { id: "tu_w1", type: "action", label: "Boas-Vindas Auto", config: { action: "set_welcome", welcome_text: "👋 Bem-vindo(a) *{nome}* ao *{grupo}*!\n\n📋 Use *{prefix}menu* para ver os comandos.\n👥 Somos *{membros}* membros!" }, position: { x: 300, y: 1840 } },
      { id: "tu_w2", type: "action", label: "Despedida Auto", config: { action: "set_goodbye", goodbye_text: "👋 *{nome}* saiu. Até mais!\n👥 Restam *{membros}*." }, position: { x: 560, y: 1840 } },
    ],
    edges: [
      { id: "tu_e1", source: "tu_c1", target: "tu_d1" }, { id: "tu_e1b", source: "tu_d1", target: "tu_a1" }, { id: "tu_e1c", source: "tu_d1", target: "tu_r0" },
      { id: "tu_e2", source: "tu_c2", target: "tu_a2" }, { id: "tu_e3", source: "tu_c3", target: "tu_a3" },
      { id: "tu_e4", source: "tu_c4", target: "tu_a4" }, { id: "tu_e5", source: "tu_c5", target: "tu_a5" },
      { id: "tu_e10", source: "tu_c10", target: "tu_a10" }, { id: "tu_e11", source: "tu_c11", target: "tu_a11" },
      { id: "tu_e12", source: "tu_c12", target: "tu_a12" }, { id: "tu_e13", source: "tu_c13", target: "tu_a13" },
      { id: "tu_e14", source: "tu_c14", target: "tu_a14" }, { id: "tu_e15", source: "tu_c15", target: "tu_a15" },
      { id: "tu_e16", source: "tu_c16", target: "tu_a16" }, { id: "tu_e17", source: "tu_c17", target: "tu_a17" },
      { id: "tu_e18", source: "tu_c18", target: "tu_a18" },
      { id: "tu_e20", source: "tu_c20", target: "tu_a20" }, { id: "tu_e21", source: "tu_c21", target: "tu_a21" },
      { id: "tu_e22", source: "tu_c22", target: "tu_a22" }, { id: "tu_e23", source: "tu_c23", target: "tu_a23" },
      { id: "tu_e24", source: "tu_c24", target: "tu_a24" }, { id: "tu_e25", source: "tu_c25", target: "tu_a25" },
      { id: "tu_e26", source: "tu_c26", target: "tu_a26" }, { id: "tu_e27", source: "tu_c27", target: "tu_a27" },
      { id: "tu_e28", source: "tu_c28", target: "tu_a28" },
      { id: "tu_e30", source: "tu_c30", target: "tu_a30" }, { id: "tu_e31", source: "tu_c31", target: "tu_a31" },
      { id: "tu_e32", source: "tu_c32", target: "tu_a32" }, { id: "tu_e33", source: "tu_c33", target: "tu_a33" },
      { id: "tu_e34", source: "tu_c34", target: "tu_a34" }, { id: "tu_e35", source: "tu_c35", target: "tu_a35" },
      { id: "tu_e36", source: "tu_c36", target: "tu_a36" }, { id: "tu_e37", source: "tu_c37", target: "tu_a37" },
      { id: "tu_e38", source: "tu_c38", target: "tu_a38" }, { id: "tu_e39", source: "tu_c39", target: "tu_a39" },
      { id: "tu_e40", source: "tu_c40", target: "tu_a40" }, { id: "tu_e41", source: "tu_c41", target: "tu_a41" },
      { id: "tu_e50", source: "tu_c50", target: "tu_a50" }, { id: "tu_e51", source: "tu_c51", target: "tu_a51" },
      { id: "tu_e52", source: "tu_c52", target: "tu_a52" }, { id: "tu_e53", source: "tu_c53", target: "tu_a53" },
      { id: "tu_e54", source: "tu_c54", target: "tu_a54" }, { id: "tu_e55", source: "tu_c55", target: "tu_a55" },
      { id: "tu_e56", source: "tu_c56", target: "tu_a56" }, { id: "tu_e57", source: "tu_c57", target: "tu_a57" },
      { id: "tu_e60", source: "tu_c60", target: "tu_a60" }, { id: "tu_e61", source: "tu_c61", target: "tu_a61" },
      { id: "tu_e62", source: "tu_c62", target: "tu_a62" },
    ],
  },
];
