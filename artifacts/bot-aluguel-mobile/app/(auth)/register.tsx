      ...
      >
        ...
        >
          <View style={s.logoArea}>
            ...
            <Text style={s.tagline}>Crie sua conta e comece agora</Text>
          </View>
          ...
          <Text style={s.label}>WHATSAPP <Text style={s.optionalText}>(opcional)</Text></Text>
          ...
          {/* Register button */}
          <Pressable
            style={({ pressed }) => [s.mainBtn, { opacity: pressed || registerMutation.isPending ? 0.85 : 1 }]}
            onPress={handleRegister}
            disabled={registerMutation.isPending}
          >
            <LinearGradient colors={["#7C3AED", "#6D28D9", "#5B21B6"]} style={s.mainBtnGradient} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}>
              {registerMutation.isPending ? (
                <ActivityIndicator color="#FFF" size="small" />
              ) : (
                <>
                  <Text style={s.mainBtnText}>Criar conta</Text>
          ...
          >
            <GoogleIcon />
            <Text style={s.googleBtnText}>Registrar com Google</Text>
          </Pressable>
      ...
      <Modal visible={showCountryPicker} animationType="slide" transparent onRequestClose={() => setShowCountryPicker(false)}>
        ...
        <View style={[s.modalSheet, { paddingBottom: insets.bottom + 20 }]}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <Pressable
                style={({ pressed }) => [s.countryRowItem, pressed && { backgroundColor: "rgba(124,58,237,0.1)" }]}
